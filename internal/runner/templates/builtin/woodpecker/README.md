...
- **postgres 用户名**: {app_name}_woodpecker
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_woodpecker
...
- `woodpecker_data`: woodpecker-server 数据存储
- `docker_sock`: woodpecker-agent 数据存储
...
1. 更多信息请访问：https://woodpecker-ci.org/
