# Favicon & Icon Generator 模板

专业的图标生成工具，支持生成 favicon、iOS/Android 应用图标、多尺寸图标等多种格式。
...
- `generator_data`: favicon-generator 数据存储
...
1. 更多信息请访问：https://realfavicongenerator.net/
