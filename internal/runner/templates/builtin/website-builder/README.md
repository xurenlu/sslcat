...
拖拽式官网快速生成工具，支持可视化编辑、响应式设计、模板库、SEO优化、多语言、一键发布等功能。
...
- **postgres 用户名**: {app_name}_website_builder
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_website_builder
- **redis 密码**: 自动生成（16位随机密码）
- **website-builder Secret Key**: 自动生成（32位随机密钥）
...
- `website_builder_data`: website-builder 数据文件
- `website_builder_storage`: website-builder 数据存储
- `website_builder_templates`: website-builder 数据存储
...
1. 更多信息请访问：https://github.com/website-builder
