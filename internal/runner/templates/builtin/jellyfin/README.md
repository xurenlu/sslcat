...
Jellyfin 是一个开源的媒体服务器，类似 Plex，可以流式传输电影、电视节目、音乐等媒体内容。
...
- `jellyfin_config`: jellyfin 配置文件
- `jellyfin_cache`: jellyfin 数据存储
- `jellyfin_media`: jellyfin 数据存储
