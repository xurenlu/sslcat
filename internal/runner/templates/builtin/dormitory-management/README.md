...
企业宿舍管理系统，支持宿舍分配、入住管理、退宿管理、费用结算等功能。
...
- **postgres 用户名**: {app_name}_dormitory
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_dormitory
- **dormitory Secret Key**: 自动生成（32位随机密钥）
...
1. 更多信息请访问：https://github.com/dormitory-management
