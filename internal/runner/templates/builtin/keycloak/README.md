...
企业级身份和访问管理解决方案，支持 SSO、OAuth2、SAML。
...
- **postgres 用户名**: {app_name}_keycloak
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_keycloak
...
1. 更多信息请访问：https://www.keycloak.org/
