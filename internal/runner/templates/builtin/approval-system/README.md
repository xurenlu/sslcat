...
- **postgres 用户名**: {app_name}_approval
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_approval
- **approval-system Secret Key**: 自动生成（32位随机密钥）
...
- `approval_system_data`: approval-system 数据文件
...
1. 更多信息请访问：https://github.com/approval-system
