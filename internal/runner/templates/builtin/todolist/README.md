...
简洁的待办事项管理工具，支持任务列表、优先级、截止日期等功能。
...
- **postgres 用户名**: {app_name}_todolist
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_todolist
...
1. 更多信息请访问：https://github.com/m1k1o/todolist
