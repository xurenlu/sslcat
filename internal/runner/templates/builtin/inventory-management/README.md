...
专业的库存管理系统，支持入库出库、库存盘点、库存预警、批次管理、条码管理等功能。
...
- **inventory Secret Key**: 自动生成（32位随机密钥）
- **postgres 用户名**: {app_name}_inventory
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_inventory
...
1. 更多信息请访问：https://github.com/inventory-management
