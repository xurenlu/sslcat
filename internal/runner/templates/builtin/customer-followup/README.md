...
专业的客户跟单管理系统，支持客户管理、跟进记录、商机管理、合同管理、销售报表等功能。
...
- **customer-followup Secret Key**: 自动生成（32位随机密钥）
- **postgres 用户名**: {app_name}_followup
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_followup
...
- `followup_data`: customer-followup 数据文件
...
1. 更多信息请访问：https://github.com/customer-followup
