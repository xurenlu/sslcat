...
自托管的代码片段管理工具，类似 Gist，支持代码高亮、标签分类、搜索等功能。
...
- **postgres 用户名**: {app_name}_snipt
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_snipt
- **snipt Secret Key**: 自动生成（50位随机密钥）
...
1. 更多信息请访问：https://github.com/nicksergeant/snipt
