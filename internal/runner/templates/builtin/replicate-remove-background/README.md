# Replicate Remove Background (智能抠图) 模板

Replicate 上的背景移除模型，智能抠图，无需 GPU。
...
- `replicate_rmbg_data`: replicate-remove-background 数据存储
...
2. 更多信息请访问：https://replicate.com/lucataco/remove-background
