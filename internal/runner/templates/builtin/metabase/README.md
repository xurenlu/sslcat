...
开源商业智能工具，可以连接多种数据源，创建可视化报表和仪表板。
...
- **postgres 用户名**: {app_name}_metabase
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_metabase
...
1. 更多信息请访问：https://www.metabase.com/
