...
开源客服系统，支持多渠道沟通，包括网站、Facebook、Twitter 等。
...
- **postgres 用户名**: {app_name}_chatwoot
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_chatwoot
...
1. 更多信息请访问：https://www.chatwoot.com/
