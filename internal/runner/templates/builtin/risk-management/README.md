...
企业风险管理系统，支持风险识别、风险评估、风险应对、风险监控、风险报告等功能。
...
- **postgres 用户名**: {app_name}_risk
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_risk
- **redis 密码**: 自动生成（16位随机密码）
- **risk-management Secret Key**: 自动生成（32位随机密钥）
...
- `risk_data`: risk-management 数据文件
...
1. 更多信息请访问：https://github.com/risk-management
