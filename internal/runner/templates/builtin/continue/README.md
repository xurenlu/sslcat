...
开源 AI 代码编辑器，支持 VS Code 插件，提供智能代码补全和生成。
...
- **postgres 用户名**: {app_name}_continue
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_continue
