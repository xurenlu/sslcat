...
- **postgres 用户名**: {app_name}_tandoor
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_tandoor
- **tandoor Secret Key**: 自动生成（50位随机密钥）
...
- `tandoor_data`: tandoor 数据存储
- `tandoor_static`: tandoor 数据存储
