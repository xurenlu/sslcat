...
开源任务管理工具，支持看板、列表、日历等多种视图，类似 Trello。
...
- **postgres 用户名**: {app_name}_taskcafe
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_taskcafe
...
1. 更多信息请访问：https://github.com/JordanKnott/taskcafe
