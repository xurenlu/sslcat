...
- `photoprism_originals`: photoprism 数据存储
- `photoprism_storage`: photoprism 数据存储
- `photoprism_import`: photoprism 数据存储
...
1. 更多信息请访问：https://www.photoprism.app/
