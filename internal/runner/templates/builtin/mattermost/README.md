...
Slack 的开源替代品，团队协作和实时聊天平台，支持频道、私聊、文件分享等。
...
- **postgres 用户名**: {app_name}_mattermost
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_mattermost
...
- `mattermost_data`: mattermost 数据文件
- `mattermost_config`: mattermost 配置文件
...
1. 更多信息请访问：https://mattermost.com/
