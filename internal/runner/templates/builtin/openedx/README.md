...
开源的在线学习平台，edX 的开源版本，支持大规模在线课程、视频学习、作业评估、证书颁发等功能。
...
- **postgres 用户名**: {app_name}_openedx
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_openedx
- **redis 密码**: 自动生成（16位随机密码）
- **openedx Secret Key**: 自动生成（64位随机密钥）
