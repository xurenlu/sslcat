...
去中心化的照片分享平台，类似 Instagram，支持 ActivityPub。
...
- **mysql 用户名**: {app_name}_pixelfed
- **mysql 密码**: 自动生成（18位随机密码）
- **mysql 数据库名**: {app_name}_pixelfed
