...
Umami 是一个简单、快速、注重隐私的网站分析工具，是 Google Analytics 的开源替代品。
...
- **postgres 用户名**: {app_name}_umami
- **postgres 密码**: 自动生成（20位随机密码）
- **postgres 数据库名**: {app_name}_umami
