...
AI 代码助手，支持代码补全、解释和生成，类似 GitHub Copilot。
...
- **postgres 用户名**: {app_name}_codeium
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_codeium
