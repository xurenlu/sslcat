...
专业的仓库管理系统（WMS），支持仓库管理、货位管理、入库出库、库存盘点、拣货管理等功能。
...
- **postgres 用户名**: {app_name}_warehouse
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_warehouse
- **warehouse Secret Key**: 自动生成（32位随机密钥）
...
1. 更多信息请访问：https://github.com/warehouse-management
