# Typeform Alternative 模板

Typeform 风格的表单工具，支持动态表单和美观的界面。
...
- **postgres 用户名**: {app_name}_typeform
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_typeform
- **typeform Secret Key**: 自动生成（32位随机密钥）
...
1. 更多信息请访问：https://www.typeform.com/
