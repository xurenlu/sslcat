# Replicate SDXL (高清图片生成) 模板

Replicate 上的 Stable Diffusion XL 模型，生成更高分辨率的图片，需要 GPU。
...
- `replicate_sdxl_data`: replicate-sdxl 数据存储
...
2. 更多信息请访问：https://replicate.com/stability-ai/sdxl
