# PostgREST (REST API) 模板

自动从 PostgreSQL 数据库生成 RESTful API，无需编写代码，直接暴露数据库为 REST API。
...
- **postgres 用户名**: {app_name}_postgrest
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_postgrest
