...
错误监控和追踪平台，实时捕获应用错误，支持多种编程语言，提供详细的错误报告。
...
- **bugsnag Secret Key**: 自动生成（50位随机密钥）
- **postgres 用户名**: {app_name}_bugsnag
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_bugsnag
...
1. 更多信息请访问：https://www.bugsnag.com/
