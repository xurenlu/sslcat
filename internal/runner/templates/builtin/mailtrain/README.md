...
开源的邮件营销平台，支持邮件列表管理、邮件模板、邮件发送、订阅管理、统计分析等功能。
...
- **mailtrain Secret Key**: 自动生成（32位随机密钥）
- **postgres 用户名**: {app_name}_mailtrain
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_mailtrain
...
1. 更多信息请访问：https://github.com/Mailtrain-org/mailtrain
