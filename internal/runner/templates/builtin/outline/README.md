...
现代化的团队知识库，界面美观，支持 Markdown 和协作编辑。
...
- **postgres 用户名**: {app_name}_outline
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_outline
- **outline Secret Key**: 自动生成（64位随机密钥）
...
1. 更多信息请访问：https://www.getoutline.com/
