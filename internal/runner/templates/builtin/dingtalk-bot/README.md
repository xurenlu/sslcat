...
钉钉机器人服务，支持消息推送、群聊机器人、工作通知、Webhook 等功能。
...
- **postgres 用户名**: {app_name}_dingtalk
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_dingtalk
- **dingtalk-bot Secret Key**: 自动生成（32位随机密钥）
...
- `dingtalk_bot_data`: dingtalk-bot 数据文件
...
1. 更多信息请访问：https://open.dingtalk.com/
