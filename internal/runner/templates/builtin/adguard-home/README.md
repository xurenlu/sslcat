# AdGuard Home (DNS过滤) 模板

网络级广告和追踪拦截器，DNS 服务器，提供详细的统计和过滤规则管理。
...
- `adguard_data`: adguard-home 数据存储
- `adguard_config`: adguard-home 数据存储
...
1. 更多信息请访问：https://adguard.com/adguard-home.html
