...
企业级 RAG 应用，支持文档上传、向量搜索、AI 问答和智能聊天。支持中文界面和中文内容处理。
...
- **postgres 用户名**: {app_name}_anythingllm
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_anythingllm
...
- `anythingllm_data`: anythingllm 数据存储
...
2. 更多信息请访问：https://useanything.com/
