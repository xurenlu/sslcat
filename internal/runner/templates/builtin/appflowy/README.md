# AppFlowy (Notion替代) 模板

Notion 的开源替代品，Rust + Flutter 构建，支持文档、数据库、看板等多种视图。
...
- **postgres 用户名**: {app_name}_appflowy
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_appflowy
...
1. 更多信息请访问：https://www.appflowy.io/
