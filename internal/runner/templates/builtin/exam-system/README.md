...
在线知识考试和评估系统，支持题库管理、在线考试、自动评分、成绩统计、证书颁发等功能。
...
- **postgres 用户名**: {app_name}_exam
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_exam
- **redis 密码**: 自动生成（16位随机密码）
- **exam-system Secret Key**: 自动生成（32位随机密钥）
...
1. 更多信息请访问：https://github.com/exam-system
