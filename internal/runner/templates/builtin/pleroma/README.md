# Pleroma (Twitter替代) 模板

轻量级的联邦社交网络服务器，Mastodon 的替代品，支持 ActivityPub 协议，资源占用更少。
...
- **postgres 用户名**: {app_name}_pleroma
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_pleroma
...
1. 更多信息请访问：https://pleroma.social/
