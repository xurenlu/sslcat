...
企业培训管理系统，支持培训计划、培训课程、培训报名、培训记录、培训评估等功能。
...
- **training-management Secret Key**: 自动生成（32位随机密钥）
- **postgres 用户名**: {app_name}_training
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_training
...
- `training_data`: training-management 数据文件
- `training_uploads`: training-management 数据存储
...
1. 更多信息请访问：https://github.com/training-management
