# Replicate Face Restoration (人脸修复) 模板

Replicate 上的人脸修复模型，修复模糊、低分辨率的人脸照片，需要 GPU。
...
- `replicate_face_restore_data`: replicate-face-restoration 数据存储
...
2. 更多信息请访问：https://replicate.com/logerzhu/face-restoration
