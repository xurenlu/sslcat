# Table Transformer (表格识别) 模板

强大的表格识别工具，从图片中提取表格并转换为 Excel/CSV，需要 GPU。
...
- `table_transformer_data`: table-transformer 数据存储
...
2. 更多信息请访问：https://github.com/microsoft/table-transformer
