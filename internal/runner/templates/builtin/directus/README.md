...
开源无头 CMS 和数据平台，提供直观的管理界面和强大的 API。
...
- **postgres 用户名**: {app_name}_directus
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_directus
...
- `directus_uploads`: directus 数据存储
- `directus_extensions`: directus 数据存储
