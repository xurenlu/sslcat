...
- **postgres 用户名**: {app_name}_plane
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_plane
- **plane Secret Key**: 自动生成（64位随机密钥）
