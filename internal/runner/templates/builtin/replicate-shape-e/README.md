# Replicate Shap-E (3D生成) 模板

Replicate 上的 OpenAI Shap-E 模型，从文本或图片生成 3D 模型，需要 GPU。
...
- `replicate_shape_e_data`: replicate-shape-e 数据存储
...
2. 更多信息请访问：https://replicate.com/openai/shap-e
