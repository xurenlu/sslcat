# Linear Alternative (项目管理) 模板

Linear 的开源替代品，现代化的项目管理工具，支持 Issue 跟踪、看板、时间线等功能。
...
- **postgres 用户名**: {app_name}_linear
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_linear
...
- `linear_alt_data`: linear-alternative 数据文件
...
1. 更多信息请访问：https://github.com/linear-alternative
