...
企业会议管理系统，支持会议室预订、会议安排、会议通知、会议纪要、会议统计等功能。
...
- **postgres 用户名**: {app_name}_meeting
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_meeting
- **redis 密码**: 自动生成（16位随机密码）
- **meeting-management Secret Key**: 自动生成（32位随机密钥）
...
- `meeting_data`: meeting-management 数据文件
...
1. 更多信息请访问：https://github.com/meeting-management
