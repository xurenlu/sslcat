...
Mozilla 开源的 Bug 追踪系统，功能强大的缺陷管理和追踪工具。
...
- **mysql 用户名**: {app_name}_bugzilla
- **mysql 密码**: 自动生成（18位随机密码）
- **mysql 数据库名**: {app_name}_bugzilla
...
1. 更多信息请访问：https://www.bugzilla.org/
