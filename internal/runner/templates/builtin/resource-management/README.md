...
企业资源管理系统，支持人力资源分配、设备资源管理、资源利用率分析、资源冲突检测等功能。
...
- **postgres 用户名**: {app_name}_resource
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_resource
- **redis 密码**: 自动生成（16位随机密码）
- **resource-management Secret Key**: 自动生成（32位随机密钥）
...
- `resource_data`: resource-management 数据文件
...
1. 更多信息请访问：https://github.com/resource-management
