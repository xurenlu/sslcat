...
- **mysql 用户名**: {app_name}_limesurvey
- **mysql 密码**: 自动生成（18位随机密码）
- **mysql 数据库名**: {app_name}_limesurvey
...
- `limesurvey_data`: limesurvey 数据存储
...
1. 更多信息请访问：https://www.limesurvey.org/
