...
在线文档协作平台，支持Word、Excel、PowerPoint在线编辑，实时协作，类似Google Docs。
...
- **postgres 用户名**: {app_name}_onlyoffice
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_onlyoffice
...
- `onlyoffice_data`: onlyoffice 数据存储
...
1. 更多信息请访问：https://www.onlyoffice.com/
