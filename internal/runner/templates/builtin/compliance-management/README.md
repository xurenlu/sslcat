...
企业合规管理系统，支持法规合规跟踪、合规检查、合规报告、风险识别等功能。
...
- **postgres 用户名**: {app_name}_compliance
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_compliance
- **redis 密码**: 自动生成（16位随机密码）
- **compliance-management Secret Key**: 自动生成（32位随机密钥）
...
- `compliance_data`: compliance-management 数据文件
...
1. 更多信息请访问：https://github.com/compliance-management
