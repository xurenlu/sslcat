# CLIP Interrogator (图片描述生成) 模板

从图片生成详细的文本描述，用于 AI 图片生成提示词，需要 GPU。
...
- `clip_interrogator_data`: clip-interrogator 数据存储
...
2. 更多信息请访问：https://github.com/pharmapsychotic/clip-interrogator
