...
企业采购门户系统，支持采购申请、采购审批、供应商选择、采购订单管理、采购统计等功能。
...
- **postgres 用户名**: {app_name}_procurement
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_procurement
- **redis 密码**: 自动生成（16位随机密码）
- **procurement-portal Secret Key**: 自动生成（32位随机密钥）
...
- `procurement_data`: procurement-portal 数据文件
...
1. 更多信息请访问：https://github.com/procurement-portal
