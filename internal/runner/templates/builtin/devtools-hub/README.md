# DevTools Hub (开发工具集) 模板

开发工具集合，包含 JSON 格式化、正则测试、编码转换、哈希生成等多种实用工具。
...
- **postgres 用户名**: {app_name}_devtools
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_devtools
...
- `devtools_hub_data`: devtools-hub 数据文件
...
1. 更多信息请访问：https://github.com/devtools-hub
