# Stable Video Diffusion (视频生成) 模板

Stability AI 的视频生成模型，从图片生成高质量视频，需要 GPU。
...
- `stable_video_diffusion_data`: stable-video-diffusion 数据存储
- `stable_video_diffusion_output`: stable-video-diffusion 数据存储
