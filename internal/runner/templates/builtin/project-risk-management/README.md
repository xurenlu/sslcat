...
项目风险识别和管理系统，支持风险识别、风险评估、风险应对计划、风险监控等功能。
...
- **postgres 用户名**: {app_name}_project_risk
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_project_risk
- **project-risk-management Secret Key**: 自动生成（32位随机密钥）
...
- `project_risk_data`: project-risk-management 数据文件
...
1. 更多信息请访问：https://github.com/project-risk-management
