# Segment Anything (图像分割) 模板

Meta 开源的图像分割模型，可以分割图片中的任何物体，需要 GPU。
...
- `segment_anything_data`: segment-anything 数据存储
...
2. 更多信息请访问：https://github.com/facebookresearch/segment-anything
