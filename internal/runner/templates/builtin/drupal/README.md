...
- **mysql 用户名**: {app_name}_drupal
- **mysql 密码**: 自动生成（18位随机密码）
- **mysql 数据库名**: {app_name}_drupal
...
- `drupal_data`: drupal 数据存储
- `drupal_modules`: drupal 数据存储
- `drupal_themes`: drupal 数据存储
- `drupal_sites`: drupal 数据存储
...
1. 更多信息请访问：https://www.drupal.org/
