...
自动化代理系统，类似 IFTTT，可以监控网站变化、发送通知、执行任务等。
...
- **postgres 用户名**: {app_name}_huginn
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_huginn
...
1. 更多信息请访问：https://github.com/huginn/huginn
