# InvoicePlane (发票管理) 模板

开源的发票管理系统，支持发票创建、客户管理、报价管理、付款追踪等功能。
...
- **mysql 用户名**: {app_name}_invoiceplane
- **mysql 密码**: 自动生成（18位随机密码）
- **mysql 数据库名**: {app_name}_invoiceplane
...
- `invoiceplane_data`: invoiceplane 数据存储
...
1. 更多信息请访问：https://www.invoiceplane.com/
