# Midjourney Alternative (艺术图片生成) 模板

Midjourney 风格的图片生成工具，生成艺术感强的图片，需要 GPU。
...
- `midjourney_alt_data`: midjourney-alternative 数据存储
...
2. 更多信息请访问：https://github.com/midjourney-alternative
