...
开源堡垒机，提供安全审计、会话录制、权限管理等功能，支持 SSH、RDP、VNC 等协议。
...
- **jumpserver Secret Key**: 自动生成（50位随机密钥）
- **mysql 用户名**: {app_name}_jumpserver
- **mysql 密码**: 自动生成（18位随机密码）
- **mysql 数据库名**: {app_name}_jumpserver
...
- `jumpserver_data`: jumpserver 数据文件
...
1. 更多信息请访问：https://www.jumpserver.org/
