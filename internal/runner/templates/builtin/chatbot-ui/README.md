...
Hugging Face 开源聊天界面，支持多种 AI 模型和自定义配置。
...
- **postgres 用户名**: {app_name}_chatbot
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_chatbot
...
- `chatbot_ui_data`: chatbot-ui 数据文件
...
2. 更多信息请访问：https://github.com/huggingface/chat-ui
