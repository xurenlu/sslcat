# Employee Directory 模板

员工通讯录和目录管理系统，支持组织架构和员工信息管理。
...
- **postgres 用户名**: {app_name}_employee
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_employee
- **employee-directory Secret Key**: 自动生成（32位随机密钥）
...
- `employee_directory_data`: employee-directory 数据存储
...
1. 更多信息请访问：https://github.com/employee-directory
