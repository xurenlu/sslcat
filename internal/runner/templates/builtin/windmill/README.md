...
现代化工作流自动化平台，支持 Python、TypeScript、Go 等多种语言，可视化工作流设计。
...
- **postgres 用户名**: {app_name}_windmill
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_windmill
- **windmill Secret Key**: 自动生成（32位随机密钥）
...
1. 更多信息请访问：https://www.windmill.dev/
