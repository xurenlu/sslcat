...
企业供应商管理系统，支持供应商信息管理、供应商评估、供应商准入、合同管理、绩效评估等功能。
...
- **postgres 用户名**: {app_name}_supplier
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_supplier
- **redis 密码**: 自动生成（16位随机密码）
- **supplier-management Secret Key**: 自动生成（32位随机密钥）
...
- `supplier_data`: supplier-management 数据文件
...
1. 更多信息请访问：https://github.com/supplier-management
