...
去中心化的社交网络平台，支持 ActivityPub 协议，类似 Twitter。
...
- **postgres 用户名**: {app_name}_mastodon
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_mastodon
...
- `mastodon_data`: mastodon-web 数据存储
...
1. 更多信息请访问：https://joinmastodon.org/
