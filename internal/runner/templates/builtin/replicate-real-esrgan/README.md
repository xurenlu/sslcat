# Replicate Real-ESRGAN (图片放大) 模板

Replicate 上的 Real-ESRGAN 模型，高质量图片放大和修复，需要 GPU。
...
- `replicate_real_esrgan_data`: replicate-real-esrgan 数据存储
...
2. 更多信息请访问：https://replicate.com/nightmareai/real-esrgan
