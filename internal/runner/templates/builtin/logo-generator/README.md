# Logo Generator (Logo生成) 模板

AI Logo 生成工具，从文本描述生成专业 Logo 设计。
...
- **postgres 用户名**: {app_name}_logo
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_logo
...
- `logo_generator_data`: logo-generator 数据文件
...
2. 更多信息请访问：https://github.com/logo-generator
