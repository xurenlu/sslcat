...
开源产品分析平台，支持事件追踪、用户分析、功能标志、会话录制等功能。
...
- **postgres 用户名**: {app_name}_posthog
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_posthog
- **redis 密码**: 自动生成（16位随机密码）
- **posthog Secret Key**: 自动生成（50位随机密钥）
