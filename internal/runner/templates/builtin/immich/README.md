...
自托管照片和视频库，类似 Google Photos，支持 AI 功能。
...
- **postgres 用户名**: {app_name}_immich
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_immich
...
- `immich_upload`: immich-server 数据存储
- `immich_model_cache`: immich-server 数据存储
