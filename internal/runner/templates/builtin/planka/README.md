...
Trello 的开源替代品，看板式项目管理工具，支持卡片、列表、标签等功能。
...
- **postgres 用户名**: {app_name}_planka
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_planka
- **planka Secret Key**: 自动生成（32位随机密钥）
