...
文档合规性检查和管理系统，支持文档合规性审核、合规性检查、合规性报告等功能。
...
- **postgres 用户名**: {app_name}_doc_compliance
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_doc_compliance
- **document-compliance Secret Key**: 自动生成（32位随机密钥）
...
- `doc_compliance_data`: document-compliance 数据文件
...
1. 更多信息请访问：https://github.com/document-compliance
