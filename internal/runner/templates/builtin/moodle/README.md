...
开源的在线学习平台（LMS），支持课程管理、在线学习、作业提交、考试评估、学习进度跟踪等功能。
...
- **postgres 用户名**: {app_name}_moodle
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_moodle
- **moodle 用户名**: {MOODLE_USERNAME}
- **moodle 密码**: 自动生成
