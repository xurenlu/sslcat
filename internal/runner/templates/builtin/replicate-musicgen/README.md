# Replicate MusicGen (音乐生成) 模板

Replicate 上的 Meta MusicGen 模型，从文本描述生成音乐，需要 GPU。
...
- `replicate_musicgen_data`: replicate-musicgen 数据存储
...
2. 更多信息请访问：https://replicate.com/meta/musicgen
