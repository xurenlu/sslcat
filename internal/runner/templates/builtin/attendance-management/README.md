...
企业考勤管理系统，支持考勤打卡、考勤统计、请假管理、加班管理、考勤报表等功能。
...
- **postgres 用户名**: {app_name}_attendance
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_attendance
- **redis 密码**: 自动生成（16位随机密码）
- **attendance-management Secret Key**: 自动生成（32位随机密钥）
...
- `attendance_data`: attendance-management 数据文件
...
1. 更多信息请访问：https://github.com/attendance-management
