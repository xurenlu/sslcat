...
- **postgres 用户名**: {app_name}_drone
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_drone
...
- `drone_data`: drone-server 数据文件
- `docker_sock`: drone-runner 数据存储
