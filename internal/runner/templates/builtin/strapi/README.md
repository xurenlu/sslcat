...
开源无头 CMS，使用 Node.js 和 PostgreSQL，提供强大的内容管理 API。
...
- **postgres 用户名**: {app_name}_strapi
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_strapi
