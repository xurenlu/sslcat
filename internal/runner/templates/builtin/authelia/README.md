...
开源身份验证和授权服务器，支持 2FA、SSO 和细粒度访问控制。
...
- **postgres 用户名**: {app_name}_authelia
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_authelia
...
1. 更多信息请访问：https://www.authelia.com/
