...
适合中小型企业的小型ERP系统，集成采购、销售、库存、财务、人事等核心功能模块。
...
- **postgres 用户名**: {app_name}_small_erp
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_small_erp
- **redis 密码**: 自动生成（16位随机密码）
- **small-erp Secret Key**: 自动生成（32位随机密钥）
...
1. 更多信息请访问：https://github.com/small-erp
