...
Bitwarden 兼容的密码管理器，轻量级、自托管，功能完整。
...
- **postgres 用户名**: {app_name}_vaultwarden
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_vaultwarden
...
- `vaultwarden_data`: vaultwarden 数据文件
...
1. 更多信息请访问：https://github.com/dani-garcia/vaultwarden
