...
企业排班管理系统，支持员工排班、班次管理、调班申请、考勤统计等功能。
...
- **postgres 用户名**: {app_name}_schedule
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_schedule
- **schedule Secret Key**: 自动生成（32位随机密钥）
...
1. 更多信息请访问：https://github.com/schedule-management
