...
Slack 机器人服务，支持消息推送、Slash命令、交互式消息、Webhook 等功能。
...
- **slack-bot Secret Key**: 自动生成（32位随机密钥）
- **postgres 用户名**: {app_name}_slack
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_slack
