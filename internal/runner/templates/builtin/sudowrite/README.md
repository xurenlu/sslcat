...
- **postgres 用户名**: {app_name}_sudowrite
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_sudowrite
...
2. 更多信息请访问：https://github.com/sudowrite
