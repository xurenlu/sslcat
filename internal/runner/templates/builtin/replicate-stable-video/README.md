# Replicate Stable Video Diffusion (视频生成) 模板

Replicate 上的 Stable Video Diffusion 模型，从图片生成高质量视频，需要 GPU。
...
- `replicate_stable_video_data`: replicate-stable-video 数据存储
...
2. 更多信息请访问：https://replicate.com/stability-ai/stable-video-diffusion
