...
专业的商务名片在线生成工具，支持自定义设计、多种模板、二维码集成、导出PDF/PNG、批量生成等功能。
...
- **business-card-generator Secret Key**: 自动生成（32位随机密钥）
- **postgres 用户名**: {app_name}_business_card
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_business_card
...
- `business_card_data`: business-card-generator 数据文件
- `business_card_templates`: business-card-generator 数据存储
- `business_card_exports`: business-card-generator 数据存储
...
1. 更多信息请访问：https://github.com/business-card-generator
