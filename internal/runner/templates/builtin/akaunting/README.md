...
开源的会计软件，适合中小企业，支持会计科目、凭证管理、财务报表、银行对账等功能。
...
- **mysql 用户名**: {app_name}_akaunting
- **mysql 密码**: 自动生成（18位随机密码）
- **mysql 数据库名**: {app_name}_akaunting
