...
实时协作的 Markdown 编辑器，支持多人同时编辑，类似 HackMD。
...
- **postgres 用户名**: {app_name}_hedgedoc
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_hedgedoc
