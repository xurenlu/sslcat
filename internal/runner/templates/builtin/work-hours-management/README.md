...
员工工时管理系统，支持工时记录、工时统计、工时审批、工时报表等功能。
...
- **postgres 用户名**: {app_name}_work_hours
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_work_hours
- **work-hours-management Secret Key**: 自动生成（32位随机密钥）
...
- `work_hours_data`: work-hours-management 数据文件
...
1. 更多信息请访问：https://github.com/work-hours-management
