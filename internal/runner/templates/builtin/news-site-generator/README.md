...
专业的新闻/媒体站快速生成工具，支持新闻发布、分类管理、标签系统、RSS订阅、评论系统、搜索功能、媒体库管理等功能。
...
- **postgres 用户名**: {app_name}_news_site
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_news_site
- **redis 密码**: 自动生成（16位随机密码）
- **news-site-generator Secret Key**: 自动生成（32位随机密钥）
...
- `news_site_data`: news-site-generator 数据文件
- `news_site_uploads`: news-site-generator 数据存储
- `news_site_media`: news-site-generator 数据存储
...
1. 更多信息请访问：https://github.com/news-site-generator
