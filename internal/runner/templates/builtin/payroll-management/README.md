...
企业薪酬管理系统，支持工资计算、社保公积金管理、个税计算、工资条发放等功能。
...
- **postgres 用户名**: {app_name}_payroll
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_payroll
- **payroll Secret Key**: 自动生成（32位随机密钥）
...
1. 更多信息请访问：https://github.com/payroll-management
