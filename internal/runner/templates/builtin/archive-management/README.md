...
企业档案管理系统，支持档案分类、档案归档、档案检索、档案借阅、档案销毁、档案统计等功能。
...
- **postgres 用户名**: {app_name}_archive
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_archive
- **archive-management Secret Key**: 自动生成（32位随机密钥）
...
- `archive_data`: archive-management 数据文件
- `archive_files`: archive-management 数据存储
...
1. 更多信息请访问：https://github.com/archive-management
