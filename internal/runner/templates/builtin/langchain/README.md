...
LangChain AI 应用开发框架，支持链式调用、工具集成和 RAG 应用开发。
...
- **postgres 用户名**: {app_name}_langchain
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_langchain
...
2. 更多信息请访问：https://github.com/langchain-ai/langchain
