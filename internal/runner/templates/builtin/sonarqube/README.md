...
- **postgres 用户名**: {app_name}_sonarqube
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_sonarqube
...
- `sonarqube_data`: sonarqube 数据文件
- `sonarqube_extensions`: sonarqube 数据存储
- `sonarqube_logs`: sonarqube 数据存储
...
1. 更多信息请访问：https://www.sonarqube.org/
