...
- **postgres 用户名**: {app_name}_plausible
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_plausible
- **clickhouse 数据库名**: {app_name}_plausible
