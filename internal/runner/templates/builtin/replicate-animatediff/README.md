# Replicate AnimateDiff (视频生成) 模板

Replicate 上的 AnimateDiff 模型，从图片生成动画视频，需要 GPU。
...
- `replicate_animatediff_data`: replicate-animatediff 数据存储
...
2. 更多信息请访问：https://replicate.com/lucataco/animatediff
