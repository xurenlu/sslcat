...
现代化的论坛和问答平台，类似 Stack Overflow，界面美观。
...
- **postgres 用户名**: {app_name}_talkyard
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_talkyard
...
1. 更多信息请访问：https://www.talkyard.io/
