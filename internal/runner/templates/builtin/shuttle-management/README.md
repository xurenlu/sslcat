...
企业班车管理系统，支持班车路线管理、预约管理、座位管理、司机管理等功能。
...
- **postgres 用户名**: {app_name}_shuttle
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_shuttle
- **shuttle Secret Key**: 自动生成（32位随机密钥）
...
1. 更多信息请访问：https://github.com/shuttle-management
