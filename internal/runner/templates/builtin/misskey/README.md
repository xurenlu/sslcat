# Misskey (Twitter替代) 模板

现代化的联邦社交网络平台，支持 ActivityPub 协议，界面美观，功能丰富，Twitter 的替代品。
...
- **postgres 用户名**: {app_name}_misskey
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_misskey
- **redis 密码**: 自动生成（16位随机密码）
- **misskey Secret Key**: 自动生成（32位随机密钥）
...
1. 更多信息请访问：https://misskey-hub.net/
