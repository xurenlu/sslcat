# Invoice Ninja (发票管理) 模板

开源的发票和账单管理系统，支持发票创建、客户管理、在线支付、时间追踪等功能。
...
- **mysql 用户名**: {app_name}_invoice
- **mysql 密码**: 自动生成（18位随机密码）
- **mysql 数据库名**: {app_name}_invoice
...
- `invoice_ninja_data`: invoice-ninja 数据存储
...
1. 更多信息请访问：https://www.invoiceninja.com/
