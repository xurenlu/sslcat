...
- **postgres 用户名**: {app_name}_openproject
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_openproject
...
- `openproject_data`: openproject 数据存储
...
1. 更多信息请访问：https://www.openproject.org/
