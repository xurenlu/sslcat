# TensorFlow Serving (模型服务) 模板

TensorFlow 模型服务框架，高性能模型推理服务，需要 GPU。
...
- `tensorflow_serving_data`: tensorflow-serving 数据存储
...
2. 更多信息请访问：https://www.tensorflow.org/tfx/guide/serving
