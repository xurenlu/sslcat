# Replicate ControlNet (精确图片生成) 模板

Replicate 上的 ControlNet 模型，通过控制条件精确生成图片，需要 GPU。
...
- `replicate_controlnet_data`: replicate-controlnet 数据存储
...
2. 更多信息请访问：https://replicate.com/lllyasviel/controlnet
