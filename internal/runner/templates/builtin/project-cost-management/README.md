...
项目成本跟踪和控制系统，支持成本预算、成本核算、成本分析、成本预警等功能。
...
- **project-cost-management Secret Key**: 自动生成（32位随机密钥）
- **postgres 用户名**: {app_name}_project_cost
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_project_cost
...
- `project_cost_data`: project-cost-management 数据文件
...
1. 更多信息请访问：https://github.com/project-cost-management
