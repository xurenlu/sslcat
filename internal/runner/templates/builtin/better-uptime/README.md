# Better Uptime (服务监控) 模板

开源服务监控和状态页面工具，监控 HTTP、TCP、Ping 等服务，生成状态页面。
...
- **postgres 用户名**: {app_name}_better_uptime
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_better_uptime
...
- `better_uptime_data`: better-uptime 数据存储
...
1. 更多信息请访问：https://github.com/betterstackhq/better-uptime
