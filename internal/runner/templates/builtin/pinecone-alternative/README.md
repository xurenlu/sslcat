# Pinecone Alternative (向量数据库) 模板

Pinecone 兼容的向量数据库，支持向量相似度搜索和索引管理。
...
- `pinecone_alt_data`: pinecone-alternative 数据文件
...
2. 更多信息请访问：https://github.com/pinecone-alternative
