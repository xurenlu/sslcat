...
Twitter 数据归档工具，支持导出和备份 Twitter 账号的推文、媒体、关注列表等数据。
...
- **postgres 用户名**: {app_name}_twitter_archive
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_twitter_archive
- **twitter-archive Secret Key**: 自动生成（32位随机密钥）
...
- `twitter_archive_data`: twitter-archive 数据文件
...
1. 更多信息请访问：https://github.com/twitter-archive
