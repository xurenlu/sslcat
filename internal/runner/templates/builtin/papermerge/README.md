...
- **postgres 用户名**: {app_name}_papermerge
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_papermerge
- **papermerge Secret Key**: 自动生成（32位随机密钥）
...
- `papermerge_data`: papermerge 配置文件
- `papermerge_documents`: papermerge 数据存储
...
1. 更多信息请访问：https://www.papermerge.com/
