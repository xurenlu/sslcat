...
员工打卡系统，支持GPS定位打卡、人脸识别打卡、二维码打卡、打卡记录统计等功能。
...
- **postgres 用户名**: {app_name}_punch_clock
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_punch_clock
- **punch-clock Secret Key**: 自动生成（32位随机密钥）
...
- `punch_clock_data`: punch-clock 数据文件
...
1. 更多信息请访问：https://github.com/punch-clock
