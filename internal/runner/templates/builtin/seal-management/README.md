...
企业印章管理系统，支持印章申请、印章审批、印章使用记录、印章防伪、印章统计等功能。
...
- **postgres 用户名**: {app_name}_seal
- **postgres 密码**: 自动生成（18位随机密码）
- **postgres 数据库名**: {app_name}_seal
- **seal-management Secret Key**: 自动生成（32位随机密钥）
...
- `seal_data`: seal-management 数据文件
- `seal_images`: seal-management 数据存储
...
1. 更多信息请访问：https://github.com/seal-management
