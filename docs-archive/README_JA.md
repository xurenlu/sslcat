...
curl -fsSL https://raw.githubusercontent.com/xurenlu/sslcat/main/scripts/install-from-release-zh.sh | sudo bash -s -- -v 1.0.11
...
- ログイン＆セキュリティ：ログイン用Captchaを一時無効化（再有効化可能）
- ドキュメント＆i18n：多言語READMEを更新；ロードマップ更新
