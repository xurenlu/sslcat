...
### macOS
- [sslcat_v1.2.1_darwin-amd64.tar.gz](https://github.com/xurenlu/sslcat/releases/download/v1.2.1/sslcat_v1.2.1_darwin-amd64.tar.gz)
- [sslcat_v1.2.1_darwin-arm64.tar.gz](https://github.com/xurenlu/sslcat/releases/download/v1.2.1/sslcat_v1.2.1_darwin-arm64.tar.gz)

### Linux
- [sslcat_v1.2.1_linux-amd64.tar.gz](https://github.com/xurenlu/sslcat/releases/download/v1.2.1/sslcat_v1.2.1_linux-amd64.tar.gz)
- [sslcat_v1.2.1_linux-arm64.tar.gz](https://github.com/xurenlu/sslcat/releases/download/v1.2.1/sslcat_v1.2.1_linux-arm64.tar.gz)
- [sslcat_v1.2.1_linux-arm.tar.gz](https://github.com/xurenlu/sslcat/releases/download/v1.2.1/sslcat_v1.2.1_linux-arm.tar.gz)

### Windows
- [sslcat_v1.2.1_windows-amd64.zip](https://github.com/xurenlu/sslcat/releases/download/v1.2.1/sslcat_v1.2.1_windows-amd64.zip)
- [sslcat_v1.2.1_windows-arm64.zip](https://github.com/xurenlu/sslcat/releases/download/v1.2.1/sslcat_v1.2.1_windows-arm64.zip)
