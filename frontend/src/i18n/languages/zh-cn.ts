...
export const zhCN: Translation = {
  ...
  tunnels: {
    title: '动态域名 / 内网穿透',
    description: '统一管理 Cloudflare Tunnel、ngrok、frp、花生壳等服务，将内网应用安全暴露到公网。',
    addProvider: '新增服务',
    editProvider: '编辑服务',
    deleteProvider: '删除服务',
    confirmDeleteProvider: '确认删除该服务？将移除所有隧道配置。',
    addTunnel: '新增隧道',
    editTunnel: '编辑隧道',
    deleteTunnel: '删除隧道',
    confirmDeleteTunnel: '确认删除该隧道？',
    providerType: '服务类型',
    providerName: '服务名称',
    descriptionLabel: '描述',
    enabled: '启用服务',
    ...
    addRow: '添加条目',
    removeRow: '移除',
    credentialPlaceholder: '例如 token、tunnel_id 等',
    optionPlaceholder: '例如 region、entrypoint 等',
    secretStored: '已保存',
    protocol: '协议',
    localAddress: '本地地址',
    localPort: '本地端口',
    ...
    lastStopped: '最近停止',
    copyLogPath: '复制路径',
    copyLogPathSuccess: '日志路径已复制',
    copyLogPathFailed: '复制日志路径失败',
    startTunnel: '启动',
    stopTunnel: '停止',
    refresh: '刷新',
    save: '保存',
    cancel: '取消',
    noProviders: '尚未配置任何内网穿透服务',
    createFirstProvider: '立即创建服务以接入 Cloudflare Tunnel、ngrok、frp 或花生壳',
    statusConnected: '已连接',
    statusDisconnected: '未连接',
    statusError: '异常',
    statusUnknown: '未知',
    statusConnecting: '连接中',
    providerBadgeAutoStart: '自动启动',
    providerBadgeDisabled: '已禁用',
  },
  proxy: {
    title: '代理配置',
    addRule: '添加规则',
