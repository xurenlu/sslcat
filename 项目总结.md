...
WithSSL 是一个功能完整的 SSL 代理服务器，使用 Go 语言开发，满足了您提出的所有需求。
...
### 5. 访问管理面板
- 地址: http://localhost:8080/withssl-panel/
- 用户名: admin
- 密码: admin*9527
...
- `--admin-prefix`: 管理面板路径前缀 (默认: "/withssl-panel")
- `--email`: SSL证书邮箱
...
WithSSL 项目已经完全满足您的需求，是一个功能完整、安全可靠的 SSL 代理服务器解决方案！
